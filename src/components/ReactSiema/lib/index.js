...
const ReactSiema = (function(_Component) {
  ...
  function ReactSiema(props) {
    ...
    const _this = _possibleConstructorReturn(
      this,
      (ReactSiema.__proto__ || Object.getPrototypeOf(ReactSiema)).call(this)
    );
  ...
  _createClass(ReactSiema, [
    ...
    },
    {
      ...
      value: function slideToCurrent() {
        this.sliderFrame.style[_transformProperty2.default] = `translate3d(-${this.currentSlide *
        ...
        if (this.pointerDown) {
          ...
          this.setStyle(
            ...
            _defineProperty(
              ...
              _transformProperty2.default,
              `translate3d(${(this.currentSlide * (this.selectorWidth / this.perPage) +
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          Object.assign(
            ...
            this.events.reduce(
              (props, event) => Object.assign({}, props, _defineProperty({}, event, _this3[event])),
              {}
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.Children.map(this.props.children, (children, index) =>
